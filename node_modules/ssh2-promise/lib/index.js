                ...
                if (!lastSSH) {
                    ...
                    lastSSH = lastSSH.then((ssh) => {
                        if (ssh.config.hoppingTool === sshConstants_1.default.HOPPINGTOOL.SOCAT) {
                            return sshUtils_1.default.checkStreamError(ssh.spawn(`socat - TCP:${sshConfig.host}:${sshConfig.port}`));
                        }
                            ...
                            return sshUtils_1.default.checkStreamError(ssh.spawn(`nc ${sshConfig.host} ${sshConfig.port}`));
                        }
                    }).then((stream) => {
